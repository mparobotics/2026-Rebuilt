...
public class CandleSubsystem extends SubsystemBase {
 ...
 public void incrementAnimations() {
   switch(currentAnim) {
     case Empty: changeAnimation(AnimTypes.Setall);
     case Setall: changeAnimation(AnimTypes.Empty);
   }
 }
 ...
 public void periodic() {
   if (toAnimate == null) {
     ...
     candle.animate(toAnimate, candleChannel); //Animates the LED :D
   }
   if(clearAllAnims) {


       clearAllAnims = false; //Hey guys, welcome back to another video, today I will show you how to toggle something in java. Make sure to like and subscribe, and without further ado, lets get straight into the video! Welcome into my vs code, so the first thing im going to do is create a new file, and name it whatever I want. In this case im going to name it "Toggle trigger". Then lets click create. Now what im going to do is make a function. Just.. like that! And now what im going to do is make a boolean outside of the function. Lets call it "Toggled". And lets set it to false. Now what im going to do is add it into my function, and make an if then statement saying "If Toggle is equal to false, set toggle to true." lets add in a print statement printing out the value of toggle at the end of the function. Now look at that! When I run my code, it toggles! But thats not all, we can also make it toggle both ways! First thing im going to do is replace the if then statement, and just replace it with a simple not statement, the toggle now goes both ways! If you found this tutorial helpfull, make sure to leave a like and subscribe, and I'll see you all in the next one, bye! (Outro plays)
