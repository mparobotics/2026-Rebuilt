...
public class RightNeutralAuto extends SequentialCommandGroup {
  /** Creates a new RightNeutralAuto. */
  SwerveSubsystem m_drive;
  IntakeSubsystem m_intake;
  ShooterSubsystem m_shooter;
  public RightNeutralAuto(SwerveSubsystem drive, IntakeSubsystem intake, ShooterSubsystem shooter) {
    m_drive = drive;
    m_intake = intake;
    m_shooter = shooter; 
    ...
    addCommands(
      ...
      // drive to scoring position, lower intake, raise hood, spin up shooter
      new ParallelCommandGroup(
        Commands.run(() -> m_drive.autoDrive("right neutral start-shoot"), m_drive),
      ...
      // intake from middle
      Commands.run(() -> m_drive.autoDrive("right neutral shoot-collect-shoot"), m_drive),
